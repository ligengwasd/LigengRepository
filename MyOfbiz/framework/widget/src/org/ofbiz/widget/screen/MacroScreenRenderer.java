...
public class MacroScreenRenderer implements ScreenStringRenderer {
    ...
    public void renderContainerBegin(Appendable writer, Map<String, Object> context, ModelScreenWidget.Container container) throws IOException {
        ...
        String inlineStyle = container.getInlineStyle(context);
        ...
        parameters.put("inlineStyle", inlineStyle);
    ...
    public void renderKdTabStripBegin(Appendable writer, Map<String, Object> context,ModelScreenWidget.KdTabStrip kdTabStrip) throws IOException{
    	String kdTabStripId = kdTabStrip.getId(context);
    	Map<String, Object> parameters = FastMap.newInstance();
    	parameters.put("id", kdTabStripId);
    	executeMacro(writer, "renderKdTabStripBegin", parameters);
    }
    ...
    public void renderKdGridBegin(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGrid kdGrid)throws IOException{
    	String name = kdGrid.getGridName(context);
    	String height = kdGrid.getHeight(context);
    	String selectable = kdGrid.getSelectable(context);
    	String editable = kdGrid.getEditable(context);
    	String sortableMode = kdGrid.getSortableMode(context);
    	String filterable = kdGrid.getFilterable(context);
    	String groupable = kdGrid.getGroupable(context);
    	String resizable = kdGrid.getResizable(context);
    	String pageSizes = kdGrid.getPageSizes(context);
    	String pageSizesInput = kdGrid.getPageSizesInput(context);
    	String refresh = kdGrid.getRefresh(context);
    	...
    	parameters.put("sortableMode", sortableMode);
    	parameters.put("filterable", filterable);
    	parameters.put("groupable", groupable);
    	parameters.put("resizable", resizable);
    	parameters.put("pageSizes", pageSizes);
    	parameters.put("pageSizesInput", pageSizesInput);
    	parameters.put("refresh", refresh);
    	executeMacro(writer, "renderKdGridBegin",parameters);
    ...
    public void renderKdGridEnd(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGrid kdGrid)throws IOException{
    	Map<String, Object> parameters = FastMap.newInstance();
    	executeMacro(writer, "renderKdGridEnd",parameters);
    	
    }
    /* Kd-Grid-DataSource */
    public void renderKdGridDataSourceBegin(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGridDataSource kdGridDataSource)throws IOException{
    	String gridName = kdGridDataSource.getGridName(context);
    	String entityName = kdGridDataSource.getEntityName(context);
    	String pageSize = kdGridDataSource.getPageSize(context);
    	String modelId = kdGridDataSource.getModelId(context);
    	String read = kdGridDataSource.getRead(context);
    	String update = kdGridDataSource.getUpdate(context);
    	String destroy = kdGridDataSource.getDestroy(context);
    	String create = kdGridDataSource.getCreate(context);
    	Map<String, Object> parameters = FastMap.newInstance();
    	parameters.put("gridName", gridName);
    	...
    	executeMacro(writer, "renderKdGridDataSourceBegin",parameters);
    }
    public void renderKdGridDataSourceEnd(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGridDataSource kdGridDataSource)throws IOException{
    	String gridName = kdGridDataSource.getGridName(context);
    	Map<String, Object> parameters = FastMap.newInstance();
    	parameters.put("gridName", gridName);
    	executeMacro(writer, "renderKdGridDataSourceEnd",parameters);
    }
    /* Kd-Grid-Columns */
    public void renderKdGridColumnsBegin(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGridColumns kdGridColumns)throws IOException{
    	Map<String, Object> parameters = FastMap.newInstance();
    	executeMacro(writer, "renderKdGridColumnsBegin",parameters);
    }
    public void renderKdGridColumnsEnd(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGridColumns kdGridColumns)throws IOException{
    	Map<String, Object> parameters = FastMap.newInstance();
    	executeMacro(writer, "renderKdGridColumnsEnd",parameters);
    }
    /*Kd-Grid-toolbar*/
    public void renderKdGridToolbarBegin(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGridToolbar kdGridToolbar)throws IOException{
    	Map<String, Object> parameters = FastMap.newInstance();
    	executeMacro(writer, "renderKdGridToolbarBegin",parameters);
    }
    public void renderKdGridToolbarEnd(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGridToolbar kdGridToolbar)throws IOException{
    	Map<String, Object> parameters = FastMap.newInstance();
    	executeMacro(writer, "renderKdGridToolbarEnd",parameters);
    }
    /*Kd-Grid-toolbar-sub*/
    public void renderKdGridToolbarSub(Appendable writer, Map<String, Object> context,ModelScreenWidget.KdGridToolbarSub kdGridToolbarSub)throws IOException{
    	String name = kdGridToolbarSub.getName(context);
    	String text = kdGridToolbarSub.getText(context);
    	Map<String, Object> parameters = FastMap.newInstance();
    	parameters.put("name", name);
    	parameters.put("text", text);
    	executeMacro(writer, "renderKdGridToolbarSub",parameters);
    }
    /*Kd-Grid-Field-*/
    public void renderKdGridField(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdGridField kdGridField)throws IOException{
    	String name = kdGridField.getName(context);
    	String type = kdGridField.getType(context);
    	String editable = kdGridField.getEditable(context);
    	Map<String, Object> parameters = FastMap.newInstance();
    	parameters.put("name", name);
    	parameters.put("type", type);
    	parameters.put("editable", editable);
    	executeMacro(writer, "renderKdGridField",parameters);
    }
    /*Kd-Grid-Column-*/
    public void renderKdGridColumn(Appendable writer, Map<String, Object> context,ModelScreenWidget.KdGridColumn kdGridColumn)throws IOException{
    	String name = kdGridColumn.getName(context);
    	String filterable = kdGridColumn.getFilterable(context);
    	String width = kdGridColumn.getWidth(context);
    	String format = kdGridColumn.getFormat(context);
    	String dropDownType = kdGridColumn.getDropDownType(context);
    	String refenceValue = kdGridColumn.getRefenceValue(context);
    	String entity = kdGridColumn.getEntity(context);
    	String nameField = kdGridColumn.getNameField(context);
    	String valueField = kdGridColumn.getValueField(context);
    	String title = kdGridColumn.getTitle(context);
    	String conditionJson = kdGridColumn.getConditionJson(context);
    	String values = kdGridColumn.getValues(context);
    	...
    	parameters.put("dropDownType", dropDownType);
    	parameters.put("refenceValue", refenceValue);
    	parameters.put("entity", entity);
    	parameters.put("nameField", nameField);
    	parameters.put("valueField", valueField);
    	parameters.put("title", title);
    	parameters.put("conditionJson", conditionJson);
    	parameters.put("values", values);
    	executeMacro(writer, "renderKdGridColumn",parameters);
    ...
    public void renderKdGridCommand(Appendable writer, Map<String, Object> context,ModelScreenWidget.KdGridCommand kdGridCommand)throws IOException{
    	String type = kdGridCommand.getType(context);
    	String name = kdGridCommand.getName(context);
    	String text = kdGridCommand.getText(context);
    	String title = kdGridCommand.getTitle(context);
    	String width = kdGridCommand.getWidth(context);
    	String url = kdGridCommand.getUrl(context);
    	String modelId = kdGridCommand.getModelId(context);
    	String click = kdGridCommand.getClick(context);
    	Map<String, Object> parameters = FastMap.newInstance();
    	parameters.put("type", type);
    	parameters.put("name", name);
    	parameters.put("text", text);
    	...
    	parameters.put("url", url);
    	parameters.put("modelId", modelId);
    	parameters.put("click", click);
    	executeMacro(writer, "renderKdGridCommand",parameters);
    }
    /*Kd-Menu*/
    public void renderKdMenuBegin(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdMenu kdMenu)throws IOException{
    	String target = kdMenu.getTarget(context);
    	String direction = kdMenu.getDirection(context);
    	String orientation = kdMenu.getOrientation(context);
    	Map<String, Object> parameters = FastMap.newInstance();
    	parameters.put("target", target);
    	parameters.put("direction", direction);
    	parameters.put("orientation", orientation);
    	executeMacro(writer, "renderKdMenuBegin",parameters);
    }
    public void renderKdMenuEnd(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdMenu kdMenu)throws IOException{
    	Map<String, Object> parameters = FastMap.newInstance();
    	executeMacro(writer, "renderKdMenuEnd",parameters);
    }
    /**kdWindow*/
    public void renderKdWindowBegin(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdWindow kdWindow)throws IOException{
    	String id = kdWindow.getId(context);
    	String title = kdWindow.getTitle(context);
    	String modal = kdWindow.getModal(context);
    	String visible = kdWindow.getVisible(context);
    	String resizable = kdWindow.getResizable(context);
    	String width = kdWindow.getWidth(context);
    	String height = kdWindow.getHeight(context);
    	Map<String, Object> parameters = FastMap.newInstance();
    	parameters.put("id", id);
    	parameters.put("title", title);
    	...
    	parameters.put("width", width);
    	parameters.put("height", height);
    	executeMacro(writer, "renderKdWindowBegin",parameters);
    }
    public void renderKdWindowEnd(Appendable writer,Map<String, Object> context,ModelScreenWidget.KdWindow kdWindow)throws IOException{
    	Map<String, Object> parameters = FastMap.newInstance();
    	executeMacro(writer, "renderKdWindowEnd",parameters);
    }
