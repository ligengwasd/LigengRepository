...
public abstract class ModelScreenWidget extends ModelWidget {
    ...
    public static class Container extends ModelScreenWidget {
        ...
        protected FlexibleStringExpander inlineStyleExdr;
        ...
        public Container(ModelScreen modelScreen, Element containerElement) {
            ...
            this.idExdr = FlexibleStringExpander.getInstance(containerElement.getAttribute("id"));
            this.styleExdr = FlexibleStringExpander.getInstance(containerElement.getAttribute("style"));
            this.inlineStyleExdr = FlexibleStringExpander.getInstance(containerElement.getAttribute("inlineStyle"));
        ...
        public String getInlineStyle(Map<String, Object> context){
        	return this.inlineStyleExdr.expandString(context);
        }
        ...
        public String rawString() {
            return "<container id=\"" + this.idExdr.getOriginal() + "\" style=\"" + this.styleExdr.getOriginal() + "\" auto-update-target=\"" + this.autoUpdateTargetExdr.getOriginal() + 
            					"\" inlineStyle=\"" + this.inlineStyleExdr.getOriginal()+
            					"\">";
        }
    }
    
    /** KdTabStrip*/
    public static  class KdTabStrip extends ModelScreenWidget{
    	public static final String TAG_NAME = "kd-tab-strip";
    	protected FlexibleStringExpander idExdr;
    	protected List<ModelScreenWidget> subWidgets;
    	
		public KdTabStrip(ModelScreen modelScreen, Element kdTabStripElement) {
			super(modelScreen, kdTabStripElement);
			this.idExdr = FlexibleStringExpander.getInstance(kdTabStripElement.getAttribute("id"));
			List<? extends Element> subElementList = UtilXml.childElementList(kdTabStripElement);
            this.subWidgets = ModelScreenWidget.readSubWidgets(this.modelScreen, subElementList);
		}
		@Override
        public String rawString() {
            return "<kd-tab-strip id= \"" + this.idExdr.getOriginal()+"\" > ";
        }
		@Override
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
            try {
                screenStringRenderer.renderKdTabStripBegin(writer, context, this);

                // render sub-widgets
                renderSubWidgetsString(this.subWidgets, writer, context, screenStringRenderer);

                screenStringRenderer.renderKdTabStripEnd(writer, context, this);
            } catch (IOException e) {
                String errMsg = "Error rendering KdTabStrip in screen named [" + this.modelScreen.getName() + "]: " + e.toString();
                Debug.logError(e, errMsg, module);
                throw new RuntimeException(errMsg);
            }
        }
    ...
    /** Kd-Ul*/
    public static  class KdUl extends ModelScreenWidget{
    	public static final String TAG_NAME = "kd-ul";
    	public FlexibleStringExpander idExdr;
    	protected List<ModelScreenWidget> subWidgets;
    	
    	public KdUl(ModelScreen modelScreen,Element kdUl){
    		super(modelScreen, kdUl);
    		this.idExdr = FlexibleStringExpander.getInstance(kdUl.getAttribute("id"));
    		List<? extends Element> subElementList = UtilXml.childElementList(kdUl);
    		this.subWidgets = ModelScreenWidget.readSubWidgets(this.modelScreen, subElementList);
    	}
    	@Override
        public String rawString() {
            return "<kd-ul id = \""+this.idExdr.getOriginal()+"\" > ";
        }
    	@Override
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
    		try {
    			screenStringRenderer.renderKdUlBegin(writer, context, this);
                // render sub-widgets
                renderSubWidgetsString(this.subWidgets, writer, context, screenStringRenderer);
                screenStringRenderer.renderKdUlEnd(writer, context, this);
			} catch (Exception e) {
				String errMsg = "Error rendering KdUl in screen named [" + this.modelScreen.getName() + "]: " + e.toString();
                Debug.logError(e, errMsg, module);
                throw new RuntimeException(errMsg);
			}
    	}
    ...
    /** Kd-Li*/
    public static  class KdLi extends ModelScreenWidget{
    	public static final String TAG_NAME = "kd-li";
    	protected FlexibleStringExpander title;
    	protected FlexibleStringExpander urlExdr;
    	protected FlexibleStringExpander typeExdr;
    	protected List<ModelScreenWidget> subWidgets;
    	
    	public KdLi(ModelScreen modelScreen,Element kdLiElement){
    		super(modelScreen, kdLiElement);
    		this.title = FlexibleStringExpander.getInstance(kdLiElement.getAttribute("title"));
    		this.urlExdr = FlexibleStringExpander.getInstance(kdLiElement.getAttribute("url"));
    		this.typeExdr = FlexibleStringExpander.getInstance(kdLiElement.getAttribute("type"));
    		List<? extends Element> subElementList = UtilXml.childElementList(kdLiElement);
    		this.subWidgets = ModelScreenWidget.readSubWidgets(this.modelScreen, subElementList);
    	}
    	@Override
        public String rawString() {
            return "<kd-li title= \"" + this.title.getOriginal()+" \" url = \""+this.urlExdr.getOriginal()+"\" type=\""+this.typeExdr.getOriginal() +"\" > ";
        }
    	@Override
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
    		try {
    			screenStringRenderer.renderKdLiBegin(writer, context, this);
                // render sub-widgets
                renderSubWidgetsString(this.subWidgets, writer, context, screenStringRenderer);
                screenStringRenderer.renderKdLiEnd(writer, context, this);
			} catch (Exception e) {
				String errMsg = "Error rendering Kdli in screen named [" + this.modelScreen.getName() + "]: " + e.toString();
                Debug.logError(e, errMsg, module);
                throw new RuntimeException(errMsg);
			}
    	...
    	public String getUrl(Map<String, Object> context){
    		return this.urlExdr.expandString(context);
    	}
    ...
    public static class KdGrid extends ModelScreenWidget{
    	...
    	protected FlexibleStringExpander gridNameExdr;
    	...
    	public KdGrid(ModelScreen modelScreen,Element kdGridElement){
    		...
    		this.gridNameExdr = FlexibleStringExpander.getInstance(kdGridElement.getAttribute("name"));
    	...
    	@Override
        public String rawString() {
            return "<kd-grid name= \"" + this.gridNameExdr.getOriginal()+"\" height=\"" +this.heightExdr.getOriginal()+"\" selectable=\""+this.selectableExdr.getOriginal()+
    	...
    	public String getGridName(Map<String, Object> context) {
            return this.gridNameExdr.expandString(context);
        }
    ...
    public static class KdGridDataSource extends ModelScreenWidget{
    	...
    	public KdGridDataSource(ModelScreen modelScreen,Element kdGridDataSourceElement){
    		...
    		this.gridNameExdr = FlexibleStringExpander.getInstance(kdGridDataSourceElement.getAttribute("gridName"));
		...
		public String rawString() {
			return "<kd-grid-datasource entityName=\""+this.entityNameExdr.getOriginal()+
									...
									"\" gridName =\""+this.gridNameExdr.getOriginal()+"\">";
		}
    	public String getGridName(Map<String, Object> context){
    		return this.gridNameExdr.expandString(context);
    	}
    ...
    public static class KdGridColumn extends ModelScreenWidget{
    	...
    	protected FlexibleStringExpander dropDownTypeExdr;
    	protected FlexibleStringExpander refenceValueExdr;
    	protected FlexibleStringExpander entityExdr;
    	protected FlexibleStringExpander nameFieldExdr;
    	protected FlexibleStringExpander valueFieldExdr;
    	protected FlexibleStringExpander titleFieldExdr;
    	protected FlexibleStringExpander conditionJsonExdr;
    	...
    	public KdGridColumn(ModelScreen modelScreen,Element kdGridColumnElement){
    		...
    		this.dropDownTypeExdr = FlexibleStringExpander.getInstance(kdGridColumnElement.getAttribute("dropDownType"));
    		this.refenceValueExdr = FlexibleStringExpander.getInstance(kdGridColumnElement.getAttribute("refenceValue"));
    		this.entityExdr = FlexibleStringExpander.getInstance(kdGridColumnElement.getAttribute("entity"));
    		this.nameFieldExdr = FlexibleStringExpander.getInstance(kdGridColumnElement.getAttribute("nameField"));
    		this.valueFieldExdr = FlexibleStringExpander.getInstance(kdGridColumnElement.getAttribute("valueField"));
    		this.titleFieldExdr = FlexibleStringExpander.getInstance(kdGridColumnElement.getAttribute("title"));
    		this.conditionJsonExdr = FlexibleStringExpander.getInstance(kdGridColumnElement.getAttribute("conditionJson"));
        ...
        public String rawString() {
            ...
            return "<kd-grid-column name=\"" + this.nameExdr.getOriginal() + "\" filterable=\"" + this.filterableExdr.getOriginal() + "\" width=\"" + 
            								   this.widthExdr.getOriginal()+"\" title = \""+this.titleFieldExdr+"\" conditionJson=\""+
            								   this.conditionJsonExdr.getOriginal()+"\" values= \" "+
            								   this.valuesExdr.getOriginal() + "\" "+
            								   "/>";
        }
    	@Override
    	...
    	public String getValueField(Map<String, Object> context){
    		return this.valueFieldExdr.expandString(context);
    	}
    	public String getNameField(Map<String, Object> context){
    		return this.nameFieldExdr.expandString(context);
    	}
    	public String getEntity(Map<String, Object> context){
    		return this.entityExdr.expandString(context);
    	}
    	public String getRefenceValue(Map<String, Object> context){
    		return this.refenceValueExdr.expandString(context);
    	}
    	public String getDropDownType(Map<String, Object> context){
    		return this.dropDownTypeExdr.expandString(context);
    	}
    	public String getName(Map<String, Object> context){
			return this.nameExdr.expandString(context);
		}
    	...
    	public String getTitle(Map<String, Object> context){
    		return this.titleFieldExdr.expandString(context);
    	}
    	public String getConditionJson(Map<String, Object> context){
    		return this.conditionJsonExdr.expandString(context);
    	}
    ...
    public static class	KdGridCommand extends ModelScreenWidget{
    	...
    	public KdGridCommand(ModelScreen modelScreen, Element kdGridCommandElement) {
			...
			this.typeExdr = FlexibleStringExpander.getInstance(kdGridCommandElement.getAttribute("type"));
			this.urlExdr = FlexibleStringExpander.getInstance(kdGridCommandElement.getAttribute("url"));
			this.modelIdExdr = FlexibleStringExpander.getInstance(kdGridCommandElement.getAttribute("modelId"));
    ...
    public static class KdGridField extends ModelScreenWidget{
    	...
    	public KdGridField(ModelScreen modelScreen,Element kdGridFieldElement){
    		...
    		this.formatExdr = FlexibleStringExpander.getInstance(kdGridFieldElement.getAttribute("format"));
    	}
		@Override
		public void renderWidgetString(Appendable writer,Map<String, Object> context,ScreenStringRenderer screenStringRenderer)
				throws GeneralException, IOException {
		...
		@Override
		public String rawString() {
			return "<kd-grid-field format=\""+this.formatExdr.getOriginal()+"\" nama=\""+this.nameExdr.getOriginal()+"\" type =\""+this.typeExdr.getOriginal()+"\" editable=\""+this.editableExdr.getOriginal()+"\"/>" ;
		}
    ...
    /** kd-menu */
    public static class KdMenu extends ModelScreenWidget{
		public static final String TAG_NAME = "kd-menu";
    	protected FlexibleStringExpander targetExdr;
    	protected FlexibleStringExpander directionExdr;
    	protected FlexibleStringExpander orientationExdr;
    	protected List<ModelScreenWidget> subWidgets;
    	
    	public KdMenu(ModelScreen modelScreen, Element kdMenuElement) {
    		super(modelScreen, kdMenuElement);
    		this.targetExdr = FlexibleStringExpander.getInstance(kdMenuElement.getAttribute("target"));
    		this.directionExdr = FlexibleStringExpander.getInstance(kdMenuElement.getAttribute("direction"));
    		this.orientationExdr = FlexibleStringExpander.getInstance(kdMenuElement.getAttribute("orientation"));
    		List<? extends Element> subElementList = UtilXml.childElementList(kdMenuElement);
    		this.subWidgets = ModelScreenWidget.readSubWidgets(this.modelScreen, subElementList);
    	}
		@Override
		public void renderWidgetString(Appendable writer,Map<String, Object> context,ScreenStringRenderer screenStringRenderer)throws GeneralException, IOException {
			try {
    			screenStringRenderer.renderKdMenuBegin(writer, context, this);
                // render sub-widgets
                renderSubWidgetsString(this.subWidgets, writer, context, screenStringRenderer);
                screenStringRenderer.renderKdMenuEnd(writer, context, this);
			} catch (Exception e) {
				String errMsg = "Error rendering kdGridColumns in screen named [" + this.modelScreen.getName() + "]: " + e.toString();
                Debug.logError(e, errMsg, module);
                throw new RuntimeException(errMsg);
		...
		@Override
		public String rawString() {
			return "<kd-menu target =\""+this.targetExdr.getOriginal()+"\" direction =\""+
										 this.directionExdr.getOriginal()+"\" orientation =\""+
										 this.orientationExdr.getOriginal()+"\" >";
		}
		public String getDirection(Map<String, Object> context){
    		return this.directionExdr.expandString(context);
    	}
    	public String getTarget(Map<String, Object> context){
    		return this.targetExdr.expandString(context);
    	}
    	public String getOrientation(Map<String, Object> context){
    		return this.orientationExdr.expandString(context);
    	}
    }
    /** kd-window */
    public static class KdWindow extends ModelScreenWidget{
    	public static final String TAG_NAME = "kd-window";
    	protected FlexibleStringExpander idExdr;
    	protected FlexibleStringExpander titleExdr;
    	protected FlexibleStringExpander modalExdr;
    	protected FlexibleStringExpander visibleExdr;
    	protected FlexibleStringExpander resizableExdr;
    	protected FlexibleStringExpander widthExdr;
    	protected FlexibleStringExpander heightExdr;
		...
		public KdWindow(ModelScreen modelScreen, Element kdWindowElement) {
			super(modelScreen, kdWindowElement);
			this.idExdr = FlexibleStringExpander.getInstance(kdWindowElement.getAttribute("id"));
			this.titleExdr = FlexibleStringExpander.getInstance(kdWindowElement.getAttribute("title"));
			this.modalExdr = FlexibleStringExpander.getInstance(kdWindowElement.getAttribute("modal"));
			this.visibleExdr = FlexibleStringExpander.getInstance(kdWindowElement.getAttribute("visible"));
			this.resizableExdr = FlexibleStringExpander.getInstance(kdWindowElement.getAttribute("resizable"));
			this.widthExdr = FlexibleStringExpander.getInstance(kdWindowElement.getAttribute("width"));
			this.heightExdr = FlexibleStringExpander.getInstance(kdWindowElement.getAttribute("height"));
			List<? extends Element> subElementList = UtilXml.childElementList(kdWindowElement);
			this.subWidgets = ModelScreenWidget.readSubWidgets(modelScreen, subElementList);
		}

		@Override
		public void renderWidgetString(Appendable writer,Map<String, Object> context,ScreenStringRenderer screenStringRenderer)throws GeneralException, IOException {
			screenStringRenderer.renderKdWindowBegin(writer, context, this);
			renderSubWidgetsString(this.subWidgets, writer, context, screenStringRenderer);
			screenStringRenderer.renderKdWindowEnd(writer, context, this);
			
		}

		@Override
		public String rawString() {
			return  "<kd-window id=\""+this.idExdr.getOriginal()+"\" title=\""+this.titleExdr.getOriginal()+
							"\" modal=\""+this.modalExdr.getOriginal()+"\" visible=\""+this.visibleExdr.getOriginal()+
							"\" resizable=\""+this.resizableExdr.getOriginal()+"\" width=\""+this.widthExdr.getOriginal()+
							"\" height=\""+this.heightExdr.getOriginal()+"\" >";
		}
		public String getId(Map<String, Object> context){
			return this.idExdr.expandString(context);
		}
		...
		public String getModal(Map<String, Object> context){
			return this.modalExdr.expandString(context);
		}
		public String getVisible(Map<String, Object> context){
			return this.visibleExdr.expandString(context);
		}
		public String getResizable(Map<String, Object> context){
			return this.resizableExdr.expandString(context);
		}
    ...
    public static class IncludeGrid extends ModelScreenWidget{
		public static final String TAG_NAME = "include-grid";
    	protected FlexibleStringExpander nameExdr;
        protected FlexibleStringExpander locationExdr;
        
        public IncludeGrid(ModelScreen modelScreen, Element widgetElement) {
			super(modelScreen, widgetElement);
			this.nameExdr = FlexibleStringExpander.getInstance(widgetElement.getAttribute("name"));
			this.locationExdr = FlexibleStringExpander.getInstance(widgetElement.getAttribute("location"));
		}
        @Override
	    public void renderWidgetString(Appendable writer,Map<String, Object> context,ScreenStringRenderer screenStringRenderer)throws GeneralException, IOException {
    	    KdGrid kdGrid = getKdGrid(context, modelScreen);
    	    kdGrid.renderWidgetString(writer, context, screenStringRenderer);
	    }
        ...
        public KdGrid getKdGrid(Map<String, Object> context,ModelScreen modelScreen){
        	KdGrid kdGrid = null;
        	String name = this.getName(context);
            String location = this.getLocation(context);
            try {
				kdGrid = GridFactory.getKdGridFromLocation(location, name, modelScreen);
			} catch (IOException e) {
        ...
        @Override
        public String rawString() {
            return "<include-grid name=\"" + this.nameExdr.getOriginal() + "\" location=\"" + this.locationExdr.getOriginal() + "\"/>";
        }
    }
