...
import org.ofbiz.widget.form.ModelFormField.KdAutoCompleteField;
import org.ofbiz.widget.form.ModelFormField.KdInputField;
import org.ofbiz.widget.form.ModelFormField.KdDatePickerField;
import org.ofbiz.widget.form.ModelFormField.KdDateTimePickerField;
import org.ofbiz.widget.form.ModelFormField.KdDropDownListField;
import org.ofbiz.widget.form.ModelFormField.KdInputField;
import org.ofbiz.widget.form.ModelFormField.KdNumericTextBoxField;
import org.ofbiz.widget.form.ModelFormField.KdTimePickerField;
...
public class MacroFormRenderer implements FormStringRenderer {
    ...
    public void renderButtonListOpen(Appendable writer, Map<String, Object> context)throws IOException{
    	StringWriter sr = new StringWriter();
    	sr.append("<@renderButtonListOpen />");
    	executeMacro(writer, sr.toString());
    }
    public void renderButtonListClose(Appendable writer, Map<String, Object> context)throws IOException{
    	StringWriter sr = new StringWriter();
    	sr.append("<@renderButtonListClose />");
    	executeMacro(writer, sr.toString());
    }
    
    
    public void renderButtonField(Appendable writer, Map<String, Object> context, ModelForm.Button kdInputField)throws IOException{
		String type = kdInputField.getType();
		String onclick = kdInputField.getOnclick();
		String style = kdInputField.getStyle();
		String value = kdInputField.getValue();
		String ajaxUrl = kdInputField.getAjaxUrl();
		String updateGridName = kdInputField.getUpdateGridName();
		StringWriter sr = new StringWriter();
    ...
    /**Kd-Input*/
    public void renderKdInputField(Appendable writer, Map<String, Object> context,KdInputField kdInputField)throws IOException{
    	ModelFormField modelFormField = kdInputField.getModelFormField();
		String id = modelFormField.getCurrentContainerId(context);
    ...
    /**renderKdDatePickerField */
	public void renderKdDatePickerField(Appendable writer,Map<String, Object> context, KdDatePickerField kdDatePickerField)throws IOException {
		ModelFormField modelFormField = kdDatePickerField.getModelFormField();
		String id = modelFormField.getCurrentContainerId(context);
		String name = modelFormField.getName();
		
		String format =  kdDatePickerField.getFormat();
	   	String max = kdDatePickerField.getMax(); 
	   	String min = kdDatePickerField.getMin();
	   	String start = kdDatePickerField.getStart();
	   	String depth = kdDatePickerField.getDepth();
	   	String defaultValue = kdDatePickerField.getDefaultValue();
		StringWriter sr = new StringWriter();
		
		if (defaultValue.equals("") || defaultValue == null) {
			defaultValue = modelFormField.getEntry(context);
		}
		
		sr.append("<@kdDatePicker ");
		sr.append("id = \"");
		sr.append(id+"");
		sr.append("\" name = \"");
		sr.append(name);
	...
	/**renderKdTimePickerField */
	public void renderKdTimePickerField(Appendable writer,Map<String, Object> context, KdTimePickerField kdTimePickerField)throws IOException {
		ModelFormField modelFormField = kdTimePickerField.getModelFormField();
		String id = modelFormField.getCurrentContainerId(context);
		String name = modelFormField.getName();
		
		String format =  kdTimePickerField.getFormat();
	   	String max = kdTimePickerField.getMax(); 
	   	String min = kdTimePickerField.getMin();
	   	String defaultValue = kdTimePickerField.getDefaultValue();
		StringWriter sr = new StringWriter();
		if (defaultValue.equals("") || defaultValue == null) {
			defaultValue = modelFormField.getEntry(context);
		}
		
		sr.append("<@kdTimePicker ");
		sr.append("id = \"");
		sr.append(id+"");
		sr.append("\" name = \"");
		sr.append(name);
	...
	/**renderKdDateTimePickerField */
	public void renderKdDateTimePickerField(Appendable writer,Map<String, Object> context, KdDateTimePickerField kdDateTimePickerField)throws IOException {
		ModelFormField modelFormField = kdDateTimePickerField.getModelFormField();
		String id = modelFormField.getCurrentContainerId(context);
		String name = modelFormField.getName();
		
		String format =  kdDateTimePickerField.getFormat();
	   	String max = kdDateTimePickerField.getMax(); 
	   	String min = kdDateTimePickerField.getMin();
	   	String defaultValue = kdDateTimePickerField.getDefaultValue();
	   	StringWriter sr = new StringWriter();
	   	if (defaultValue.equals("") || defaultValue == null) {
			defaultValue = modelFormField.getEntry(context);
		}
		sr.append("<@kdDateTimePicker ");
		sr.append("id = \"");
		sr.append(id+"");
		sr.append("\" name = \"");
		sr.append(name);
	...
	/**renderKdAutoCompleteField */
	public void renderKdAutoCompleteField(Appendable writer,Map<String, Object> context, KdAutoCompleteField kdAutoCompleteField)throws IOException {
		ModelFormField modelFormField = kdAutoCompleteField.getModelFormField();
		String id = modelFormField.getCurrentContainerId(context);
		String name = modelFormField.getName();
		
		/*String entityId =  DelegatorFactory.getDelegator("delegator").getModelEntity(entityName).getPkFieldNames().get(0);
		System.out.println(entityId);*/
		String entityName = kdAutoCompleteField.getEntityName();
		String nameField = kdAutoCompleteField.getNameField();
		String valueField = kdAutoCompleteField.getValueField();
		String delay = kdAutoCompleteField.getDelay();
		String height = kdAutoCompleteField.getHeight();
		String minLength = kdAutoCompleteField.getMinLength();
		String placeholder = kdAutoCompleteField.getPlaceholder();
		
		StringWriter sr = new StringWriter();
		sr.append("<@kdAutoComplete ");
		sr.append("id = \"");
		sr.append(id+"");
		sr.append("\" name = \"");
		sr.append(name);
		sr.append("\" entityName = \"");
		sr.append(entityName);
		sr.append("\" nameField = \"");
		sr.append(nameField);
	...
	public void renderKdDropDownListField(Appendable writer, Map<String, Object> context,KdDropDownListField kdDropDownListField)throws IOException {
		...
		String conditionName = kdDropDownListField.getConditionName();
		String conditionValue = kdDropDownListField.getConditionValue();
		...
		sr.append("\" value =\"");
		sr.append(value);
		sr.append("\" conditionName = \"");
		sr.append(conditionName);
		sr.append("\" conditionValue = \"");
		sr.append(conditionValue);
		sr.append("\" />");
		executeMacro(writer, sr.toString());
	}
	/** renderKdNumericTextBoxField */
	public void renderKdNumericTextBoxField(Appendable writer, Map<String, Object> context,KdNumericTextBoxField kdNumericTextBoxField) throws IOException{
		ModelFormField modelFormField = kdNumericTextBoxField.getModelFormField();
		String id = modelFormField.getCurrentContainerId(context);
		String name = modelFormField.getName();
	
		String format = kdNumericTextBoxField.getFormat();
    	String culture = kdNumericTextBoxField.getCulture();
    	String decimals = kdNumericTextBoxField.getDecimals();
    	String max = kdNumericTextBoxField.getMax();
    	String min = kdNumericTextBoxField.getMin();
    	String placeholder = kdNumericTextBoxField.getPlaceholder();
    	String value = kdNumericTextBoxField.getValue();
    	String step = kdNumericTextBoxField.getStep();
    	if (value.equals("") || value == null) {
			value = modelFormField.getEntry(context);
		}
    	
    	StringWriter sr = new StringWriter();
		sr.append("<@kdNumericTextBox ");
		sr.append("id = \"");
		sr.append(id);
		sr.append("\" name = \"");
		sr.append(name);
    ...
    public void renderFieldTitle(Appendable writer, Map<String, Object> context, ModelFormField modelFormField) throws IOException {
        ...
        if (UtilValidate.isNotEmpty(titleText)) {
            if (" ".equals(titleText) || "vacant".equals(titleText)) {
