...
function submitFormDisableSubmits(form) {
	alert(document.getElementById("EditDemoProject_startdate").Value);
...
/** grid messages  add by ligeng
 *  style="position:absolute; left:35%;top:25%;z-index:8003;width:200px;height:40px;background-color:red;"
 * 
 */
