function findTableDirOptions(entityName,nameField,valueField,conditionJson){
	var data;
	var url = 'findTableDirOptions?entityName='+entityName+'&nameField='+nameField+'&valueField='+valueField+'&conditionJson='+conditionJson;
	$.ajax({url:url,
			async:false,
			success:function(e){           
				if (e != null) {
...
;(function($){
	...
	$.fn.serializeObjectToJson = function()
	{
	     ...
	     */
	   var o = {};
	   var notCheck = $("input:checkbox").not("input:checked");
