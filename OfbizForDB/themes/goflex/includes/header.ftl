...
<script type="text/javascript" charset="utf-8">
	$(document).ready(function(){
		$('#main-app-caption').hover(function(){
			$('#main-navigation').show();
		});
		
		var selected_main_text = $('#main-navigation a.selected').text();
		$('#main-app-caption span').text(selected_main_text);
	});
</script>
...
<!-- TODO workbench start-->
<#if workbenchActive?has_content>

<#else>
<div id="main-app-caption">
 ...
 <!-- TODO workbench start-->
  ...
  <#--<br class="clear" />-->
    <link rel="stylesheet" href="/goflex/woo/css/button.css" type="text/css" />
    <link rel="stylesheet" href="/goflex/woo/css/modules.css" type="text/css" />
    
    <link rel="stylesheet" href="/goflex/woo/css/layout.css" type="text/css" />
    <link rel="stylesheet" href="/goflex/woo/css/menus.css" type="text/css" /> 