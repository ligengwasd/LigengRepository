...
<head>
    ...
    <link rel="stylesheet" href="/bambook/kendo.metro.min.css" type="text/css"/>
   <link rel="stylesheet" href="/bambook/ECstyle.index.min.css" type="text/css"/>
</head>
...
<div class="pagebody">
 <div class="header" >
      <div class="logo">
         <span><img src="/bambook/images/cgjlogo2.png" width="87" height="67" /></span>
         <span><img src="/bambook/images/name.png" width="535" height="50" /></span>
      </div>
      ...
      <div class="Rherder">
            ...
            <#if layoutSettings.topLines?has_content>
              <#list layoutSettings.topLines as topLine>
                <#if topLine.text?exists>
                  ${topLine.text}<a href="${StringUtil.wrapString(topLine.url?if_exists)}${externalKeyParam}">${topLine.urlText?if_exists}</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <#elseif topLine.dropDownList?exists>
                  <a><#include "component://common/webcommon/includes/insertDropDown.ftl"/></a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <#else>
                  <a href="#">${topLine?if_exists}</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                </#if>
              </#list>
            <#else>
        ...
        <ul class="forms">
             <li>
                <span class="k-textbox k-space-left" style=" width:265px;">
